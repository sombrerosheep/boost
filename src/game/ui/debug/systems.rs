...
pub const ENTITY_COUNT: DiagnosticId = DiagnosticId::from_u128(187513512115068938494459732780662867798);
...
pub fn update_debug_ui_redraw_timer(mut ui_redraw_timer: ResMut<DebugUIUpdateTimer>, time: Res<Time>) {
